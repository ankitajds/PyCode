# generated by java
import _helper
_helper.sql='select * from  (Select "OrgFreq" AS "OrgFreq","LoanCount" AS "LoanCount","Term" AS "Term","FirstLoanDate" AS "FirstLoanDate","VedaDate" AS "VedaDate","VedaNameReportDate" AS "VedaNameReportDate","client_id" AS "client_id","LoanID" AS "LoanID","approved_principal" AS "approved_principal","disbursedon_date" AS "disbursedon_date","AmtToRepay" AS "AmtToRepay","GoodBadGrossProfitOnPrinci" AS "GoodBadGrossProfitOnPrinci","MaxProfitPossible" AS "MaxProfitPossible","GoodBadMaxDaysLate" AS "GoodBadMaxDaysLate" from cafebot.PT54172761S where 1=1      )   t1 '
base_path='\opt\cafebot\tmp\output'
publish_path = "\opt\cafebot\nifi\in\PT54172761S.csv"
_helper.generated_tablename='PT54172761S'
_helper.tablename="tablename"
